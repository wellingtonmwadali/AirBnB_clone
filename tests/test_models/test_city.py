...
class TestCityDocs(unittest.TestCase):
    ...
    @classmethod
    def setUpClass(cls):
        """class that set up the doc tests"""
    ...
    def test_pep8_conformance_test_city(self):
        """Test that tests module conforms to PEP8."""
        pep8s = pep8.StyleGuide(quiet=True)
    ...
    def test_city_func_docstrings(self):
        """Test presence of docstrings in City methods"""
...
class TestCity(unittest.TestCase):
    ...
    def test_name_attr(self):
        """Test City attribute name, and it's an empty string"""
        city = City()
        self.assertTrue(hasattr(city, "name"))
        self.assertEqual(city.name, "")

    def test_state_id_attr(self):
        """Test city attribute state_id, and it's an empty string"""
        city = City()
        self.assertTrue(hasattr(city, "state_id"))
        self.assertEqual(city.state_id, "")

    def test_to_dict_creates_dict(self):
        """test dictionary with proper attrs"""
        c = City()
        new_d = c.to_dict()
