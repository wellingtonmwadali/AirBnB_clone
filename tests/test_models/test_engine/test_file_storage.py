...
class TestFileStorageInit(unittest.TestCase):
    ...
    def test_file_path_is_a_private_class_attr(self):
        """file_path is a private class attribute"""
        self.assertFalse(hasattr(FileStorage(), "__file_path"))

    def test_objects_is_a_private_class_attr(self):
        """objects private class attribute"""
...
class TestStorageMethods(unittest.TestCase):
    """test cases for FileStorage method"""
    ...
    def test_all_method(self):
        """Tests all() method of the FileStorage"""
    ...
    def test_new_method(self):
        ...
        # if more than one arg were passed, raise typeError
        with self.assertRaises(TypeError):
    ...
    def test_save_method(self):
        """reload() method in class FileStorage"""
        dummy_bm = BaseModel()
        dummy_user = User()
        dummy_state = State()
        dummy_city = City()
